...
model = dict(
    ...
    train_cfg=dict(
        work_dir=
        'work_dirs/local-exp811/240810_1100_gtaHR2csHR_1024x1024_dacs_a999_fdthings_rcs001-20_cpl2_m64-07-spta_hrda1-512-01_dlv2red_sl_r101v1c_poly10warm_s0_2c57e',
        log_config=dict(
            interval=50,
            img_interval=1000,
            hooks=[dict(type='TextLoggerHook', by_epoch=False)])),
...
name = '240810_1100_gtaHR2csHR_1024x1024_dacs_a999_fdthings_rcs001-20_cpl2_m64-07-spta_hrda1-512-01_dlv2red_sl_r101v1c_poly10warm_s0_2c57e'
exp = 811
...
work_dir = 'work_dirs/local-exp811/240810_1100_gtaHR2csHR_1024x1024_dacs_a999_fdthings_rcs001-20_cpl2_m64-07-spta_hrda1-512-01_dlv2red_sl_r101v1c_poly10warm_s0_2c57e'
git_rev = 'unknown'
gpu_ids = range(1, 2)
