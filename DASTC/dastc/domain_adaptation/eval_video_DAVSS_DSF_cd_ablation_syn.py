...
def eval_video_single(cfg, models,
    ...
    for index, batch in tqdm(enumerate(test_loader)):
        ...
        with torch.no_grad():
            ...
            # vis seg maps
            os.makedirs('/DASTC/experiments_result/snapshots/SynthiaSeq2CityscapesSeq_ACCEL_DeepLabv2_TPS_DAVSS_DSF_cd_ablation_24/syn24', exist_ok=True)
            amax_output_col.save('%s/%s_color.png' % ('/DASTC/experiments_result/snapshots/SynthiaSeq2CityscapesSeq_ACCEL_DeepLabv2_TPS_DAVSS_DSF_cd_ablation_24/syn24', image_name))
        label = label.numpy()[0]
