...
cfg.DATA_DIRECTORY_TARGET = '../../video_seg/DASTC/data/Cityscapes'
cfg.TRAIN.MODEL = 'ACCEL_DeepLabv2'
cfg.TRAIN.flow_path_src = ''
cfg.TRAIN.flow_path = '../../video_seg/DASTC/data/estimated_optical_flow_cityscapes_seq_train'
...
cfg.TEST.DAVSS_DSF_cd_ablation_31 = ('/DASTC/experiments_result/snapshots/Viper2CityscapesSeq_ACCEL_DeepLabv2_TPS_DAVSS_DSF_cd_ablation_31',)

cfg.TEST.DAVSS_DSF_cd_ablation_24 = ('/DASTC/experiments_result/snapshots/SynthiaSeq2CityscapesSeq_ACCEL_DeepLabv2_TPS_DAVSS_DSF_cd_ablation_24',)
...
cfg.TEST.INTERVAL = 1
cfg.TEST.flow_path = '../../video_seg/DASTC/data/estimated_optical_flow_cityscapes_seq_val'
