'''
cd /home/ZZF/video_tps/TPS
python ./tps/scripts_ablation/test_DAVSS_DSF_cd_ablation_24.py --cfg ./tps/scripts_ablation/configs/tps_syn2city.yml

python ./tps/scripts_ablation/test_DAVSS_DSF_cd_ablation_24.py --cfg ./tps/scripts_ablation/configs/sourceonly_syn2city.yml
...
import sys
sys.path.append('/home/ZZF/video_tps/TPS')
...
from tps.domain_adaptation_ablation.eval_video_DAVSS_DSF_cd_ablation_24 import evaluate_domain_adaptation
