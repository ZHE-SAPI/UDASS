...
python ./tps/scripts_ablation/test_DAVSS_DSF_cd_ablation_31.py --cfg ./tps/scripts_ablation/configs/tps_syn2city.yml

python ./tps/scripts_ablation/test_DAVSS_DSF_cd_ablation_31.py --cfg ./tps/scripts_ablation/configs/sourceonly_syn2city.yml
...
import sys
sys.path.append('/home/customer/Desktop/ZZ/FMFSemi/TransferLearning/examples/domain_adaptation/video_tps/TPS')
...
if __name__ == '__main__':
    ...
    print(args)
    print('cfg.TEST.RESTORE_FROM_SYN', cfg.TEST.RESTORE_FROM_SYN)
    print('cfg.TEST.RESTORE_FROM', cfg.TEST.RESTORE_FROM)
    print('cfg.TEST.MODE', cfg.TEST.MODE)
    print('len(cfg.TEST.RESTORE_FROM_SYN)', len(cfg.TEST.RESTORE_FROM_SYN))
