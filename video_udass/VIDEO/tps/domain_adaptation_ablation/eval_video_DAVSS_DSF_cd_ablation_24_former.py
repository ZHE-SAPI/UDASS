...
def eval_video_best(cfg, models,
    ...
    assert osp.exists(cfg.TEST.DAVSS_DSF_cd_ablation_24_former[0]), 'DAVSS_DSF_cd_ablation_24_former is not found'
    ...
    cache_path = osp.join(cfg.TEST.DAVSS_DSF_cd_ablation_24_former[0], 'all_res.pkl')
    ...
    restore_from = osp.join(cfg.TEST.DAVSS_DSF_cd_ablation_24_former[0], f'udass_syn_model_video_vit.pth')
    ...
    if cfg.SOURCE == 'SynthiaSeq':
        ### ignore 'fence' class during evaluation
        inters_over_union_classes = np.concatenate((inters_over_union_classes[:3], inters_over_union_classes[4:])) 
        # following the pattern of TPS and DA-VSN, etc, https://github.com/xing0047/TPS/tree/main, https://github.com/Dayan-Guan/DA-VSN
