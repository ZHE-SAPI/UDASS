...
def eval_video_best(cfg, models,
    ...
    cache_path = osp.join(cfg.TEST.DAVSS_DSF_cd_ablation_31[0], 'all_res.pkl')
    ...
    # for i_iter in range(start_iter, max_iter + 1, step):
    restore_from = osp.join(cfg.TEST.DAVSS_DSF_cd_ablation_31[0], f'udass_viper_model_video_cnn.pth')
