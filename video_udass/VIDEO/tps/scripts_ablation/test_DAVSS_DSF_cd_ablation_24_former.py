...
CUDA_VISIBLE_DEVICES=0 python ./tps/scripts_ablation/test_DAVSS_DSF_cd_ablation_24_former.py --cfg ./tps/scripts_ablation/configs/tps_syn2city.yml
...
from tps.domain_adaptation_ablation.eval_video_DAVSS_DSF_cd_ablation_24_former import evaluate_domain_adaptation
