...
# from tps.model.accel_deeplabv2_dsp_cd_DFF_gaijin_former import get_accel_deeplab_v2
from tps.model.get_accel_deeplab_v2_tps_former import get_accel_deeplab_v2_tps
...
from tps.domain_adaptation_ablation.train_video_DAVSS_DSF_cd_ablation_31_former import train_domain_adaptation
...
def main():
    ...
    if cfg.EXP_NAME == '':
        cfg.EXP_NAME = f'{cfg.SOURCE}2{cfg.TARGET}_{cfg.TRAIN.MODEL}_{cfg.TRAIN.DA_METHOD}_DAVSS_DSF_cd_ablation_31_former'
    ...
    # checkpoint = '/home/customer/Desktop/ZZ/FMFSemi/TransferLearning/examples/domain_adaptation/video_tps/TPS/experiments_result/snapshots/Viper2CityscapesSeq_ACCEL_DeepLabv2_TPS_DAVSS_DSF_cd_ablation_31_former/daformer_model_4000.pth'
    # saved_state_dict = torch.load(checkpoint)
    # daformer_model.load_state_dict(saved_state_dict)





    # RESTORE_FROM = '/home/customer/Desktop/ZZ/FMFSemi/TransferLearning/examples/domain_adaptation/video_tps/TPS/pretrained_models/tps_syn2city_pretrained.pth'
    # RESTORE_FROM = '/home/customer/Desktop/ZZ/FMFSemi/TransferLearning/examples/domain_adaptation/video_tps/TPS/pretrained_models/tps_syn2city_pretrained.pth'
    # RESTORE_FROM = '/home/customer/Desktop/ZZ/FMFSemi/TransferLearning/examples/domain_adaptation/video_tps/TPS/pretrained_models/tps_syn2city_pretrained.pth'
    # RESTORE_FROM = '/home/customer/Desktop/ZZ/FMFSemi/TransferLearning/examples/domain_adaptation/video_tps/TPS/pretrained_models/tps_syn2city_pretrained.pth'
    # RESTORE_FROM = '/home/customer/Desktop/ZZ/FMFSemi/TransferLearning/examples/domain_adaptation/video_tps/TPS/pretrained_models/tps_syn2city_pretrained.pth'
    ...
    train_domain_adaptation(daformer_model, model_tps, source_loader, target_loader, cfg, device)
